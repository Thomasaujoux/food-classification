...
df = pd.DataFrame(columns=["playlist_id", "playlist_name", "track_number", "track_uri", "artist_name", "track_name", "album_name", "duration_ms", 'danceability', 'energy', 'key', 'loudness', 'mode', 'speechiness', 'acousticness', 'instrumentalness', 'liveness', 'valence', 'tempo', 'time_signature'])
for i in range(1000):
...
df.to_csv(r"C:\Users\Thomas Aujoux\Documents\GitHub\regression\raw_data_feature.cvs")
data = df.copy()   

new_data = data.groupby(['playlist_id'])[['duration_ms', 'danceability', 'energy', 'key', 'loudness', 'mode', 'speechiness', 'acousticness', 'instrumentalness', 'liveness', 'valence', 'tempo', 'time_signature', 'diff_duration_ms', 'diff_danceability', 'diff_energy', 'diff_key', 'diff_loudness', 'diff_mode', 'diff_speechiness', 'diff_acousticness', 'diff_instrumentalness', 'diff_liveness', 'diff_valence', 'diff_tempo', 'diff_time_signature']].mean().reset_index()

new_data.to_csv(r"C:\Users\Thomas Aujoux\Documents\GitHub\regression\data_feature.cvs")
